...
public class PairBulbsActivityStep2 extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pair_bulbs_step2);
            ...
            case R.id.btn_continue:
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        intent.putExtra("title", "Bulb Setup");
                        intent.putExtra("tips", "Something went wrong, try pairing your bulbs again.");
                        intent.putExtra("error", R.mipmap.pair_failed_bulbs);
