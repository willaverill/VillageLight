...
public class FirmwareSwitchUpdateActivity extends BaseActivity {
...
//                                    params.backgroundColorPress = Color.RED;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_firmware_update_switch);
        ...
        mTvTitle.setText("Update Switch Firmware");
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_update_firmware:
                ...
                showDownloadDialog("Downloading Switch Firmware",
                        "Please wait while the update is trans- ferred to the controller.\n\n"+
                ...
                try {
                    ...
                    byte[] firsts = {(byte) 0xAA, 0x62, 0x00, firstSer, 0x00, 0x01,
                            ...
                            sums[0], sums[1], sums[2], sums[3], 0x53, 0x00, 0x55};//0x53中继
...
//                                params.backgroundColorPress = Color.BLUE;
                ...
                .setText("Make sure your switch’s status light is NOT flashing red and green. (It’s ok if it’s flashing red only, or green only, but not both.)\n\n"+
                        "Still want to end the update?")
                .configText(new ConfigText() {
                    @Override
                    public void onConfig(TextParams params) {
//                                    params.padding = new int[]{150, 10, 50, 10};
...
//                                params.backgroundColorPress = Color.BLUE;
                ...
                .setText("The firmware update was successful. All switches must now be paired again. \n" +
                        "\n" +
                        "Press continue to begin pairing.\n")
                .configText(new ConfigText() {
                    @Override
                    public void onConfig(TextParams params) {
//                                    params.padding = new int[]{150, 10, 50, 10};
...
//                                    params.backgroundColorPress = Color.RED;
    ...
    private void upgradeComplete() {
        ...
        new CircleDialog.Builder()
                .setCanceledOnTouchOutside(false)
                .setTitle("All Done!")
                .setText("If your switch doesn’t respond, simply pair it again.")
