...
public class PairDeviceSucceedActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pair_device_succeed);
    ...
    public static final int BackToControlMenu = 100;

    @OnClick({R.id.btn_title_left, R.id.btn_continue, R.id.btn_again})
