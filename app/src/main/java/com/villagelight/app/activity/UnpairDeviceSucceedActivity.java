...
public class UnpairDeviceSucceedActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_unpair_device_succeed);
    ...
    public void onEventMainThread(PairEvent event) {
        ...
        if (event.getBulbs() == -1 && event.getSwitches() == -1) {
            mTvBulbs.setText(ProjectApp.getInstance().getSyncBulbs() + " Bulbs");
            mTvSwitches.setText(ProjectApp.getInstance().getSyncSwitches() + " Switches");
        }
